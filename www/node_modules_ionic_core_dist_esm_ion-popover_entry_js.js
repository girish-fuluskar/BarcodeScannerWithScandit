  ...
  switch (triggerAction) {
    case 'hover':
      ...
      triggerCallbacks = [{
        eventName: 'mouseenter',
        callback: function () {
          var _ref = (0,_Users_girish_Documents_LTI_Sooner_datacapture_cordova_samples_BarcodeCaptureViewsSample_template_src_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (ev) {
            ev.stopPropagation();
...
const configureKeyboardInteraction = popoverEl => {
  const callback = /*#__PURE__*/function () {
    var _ref2 = (0,_Users_girish_Documents_LTI_Sooner_datacapture_cordova_samples_BarcodeCaptureViewsSample_template_src_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (ev) {
      var _a;
